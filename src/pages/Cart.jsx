...
export default function Cart() {
  ...
  return (
    <div className="flex flex-col lg:flex-row justify-center max-w-6xl mx-auto p-8 mt-24 space-y-8 lg:space-y-0">
      {cart.length > 0 ? (
      ...
      {cart.length > 0 && (
        <div className="lg:ml-8 p-6 flex flex-col justify-between h-[80vh] w-full lg:w-1/3 lg:sticky lg:top-20 bg-white rounded-lg shadow-lg">
          <div>
